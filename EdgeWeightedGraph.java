...
public class EdgeWeightedGraph {
    ...
    public EdgeWeightedGraph(String in, int numberOfV, int numberOfE) {

        String[] splittedStringGraph = in.split();
        ...
        int E = numberOfE;
        for (int i = 0; i < E; i++) {
            int v = splittedStringGraph[i];
            int w = splittedStringGraph[i + 1];
            validateVertex(v);
            validateVertex(w);
            double weight = splittedStringGraph[i + 2];
            Edge e = new Edge(v, w, weight);
            addEdge(e);
        }
    }
